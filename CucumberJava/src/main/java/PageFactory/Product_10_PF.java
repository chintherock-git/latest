...
public class Product_10_PF {
	...
	public Product_10_PF(WebDriver driver) {
		this.driver=driver;
	...
	public 	void  store_product10_details() {
		try {
			File f_new = new File(System.getProperty("user.dir")+"/target/Output/product_10.txt");
