...
public class Product_15_PF {
	...
	public Product_15_PF(WebDriver driver) {
		this.driver=driver;
	...
	public 	void  store_product15_details() {
		try {
			File f_new = new File(System.getProperty("user.dir")+"/target/Output/product_15.txt");
